...
export const MacbookScroll = ({
  src = "/dashboard.png", // Default image path
  showGradient,
  title,
  badge,
}) => {
  ...
  return (
    ...
    >
      ...
      {/* Lid */}
      <Lid
        src={src} // Pass the `src` prop to the `Lid` component
        scaleX={scaleX}
        scaleY={scaleY}
        rotate={rotate}
        translate={translate}
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <Image
          src={src || "/default-image.png"} // Fallback to a default image if `src` is empty
          alt="aceternity logo"
          fill
